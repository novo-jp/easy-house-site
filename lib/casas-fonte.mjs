/**
 * lib/casas-fonte.mjs — leitura da tabela `casas_venda_aichi`.
 *
 * A extensão .mjs é obrigatória: o projeto não tem package.json, então a
 * Vercel trata arquivos .js como CommonJS e `import.meta.url` (usado aqui
 * para achar os JSON de configuração) quebra a função inteira na
 * invocação. O Node local aceita, porque detecta ESM sozinho — ou seja,
 * o erro só aparece em produção.
 *
...
import { normalizarCasa, ehPublicavel } from './casas.mjs';
